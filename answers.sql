...
SELECT models.name, brands.name, brands.headquarters FROM models JOIN brands ON models.brand_id = brands.brand_id 
...
SELECT models.year, models.name, models.model_id, awards.name FROM models LEFT JOIN awards ON models.model_id = awards.winner_id
